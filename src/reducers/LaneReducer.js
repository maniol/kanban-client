import { CREATE_LANE, UPDATE_LANE, DELETE_LANE } from '../actions/LaneActions';
...
export default function lanes(state = initialState, action) {
	switch (action.type) {
		...
		case UPDATE_LANE:
			return state.data.map(lane =>
				{ return lane.id === action.laneId ? Object.assign({}, lane, action.lane) : lane })
		case DELETE_LANE:
